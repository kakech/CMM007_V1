...
echo "<div class='col-md-12'>";
	...
	<form action='update_user.php?id=<?php echo $user_id; ?>' method='post' id='update-user'>
	    ...
	    <table class='table table-hover table-responsive table-bordered'>
			...
			// else there's the choice, either the user will be 'Admin' or 'Student'
			else{
			?>
			...
			<tr>
	            ...
	            <td>
					<div class="btn-group" data-toggle="buttons">
						...
						<label class="btn btn-default <?php echo $user->access_level=='Student' ? 'active' : ''; ?>">
							<input type="radio" name="access_level" value="Student" <?php echo $user->access_level=='Student' ? 'checked' : ''; ?>> Student
						</label>
